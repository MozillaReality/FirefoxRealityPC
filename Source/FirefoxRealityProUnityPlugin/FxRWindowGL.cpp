...
void FxRWindowGL::initDevice() {
#ifdef _WIN32
	gl3wInit();
#endif
}

void FxRWindowGL::finalizeDevice() {
}

FxRWindowGL::FxRWindowGL(int uid, int uidExt, Size size) :
...
bool FxRWindowGL::init(PFN_WINDOWCREATEDCALLBACK windowCreatedCallback)
{
	switch (m_format) {
